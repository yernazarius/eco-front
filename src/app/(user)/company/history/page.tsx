...
export default function HistoryPage() {
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p className='text-primary_text'>В 1993 небольшая группа единомышленников, выходцев с географического факультета МГУ, объединилась для разработки нового иономера – прибора для измерения ионного состава природных вод в целях экологического мониторинга. Проект оказался успешен и вскоре компания открыла свой первый зарубежный офис в Нидерландах, дополнив предлагаемые решения датчиками и анализаторами зарубежного производства. Сохранив первоначальный коллектив профессиональных химиков, метрологов и инженеров до сегодняшнего дня, ЭкоИнструмент постоянно развивался, создав и расширяя дилерскую сеть продаж, а также открывая представительства в региональных центрах России и СНГ.
			</p>
			<ul className='pl-6 mt-8 list-disc flex flex-col gap-4'>
				...
				<li>2000 год:Экоинструмент-Волга
					<ul>
						<li className='ml-6 text-primary_text mb-1'>региональный офис ЭкоИнструмент-Волга в Нижнем Новгороде
						</li>

					</ul>
				</li>
				<li>2001 год:Экоинструмент-Урал


					<ul>
						<li className='ml-6 text-primary_text mb-1'>региональный офис ЭкоИнструмент-Урал в Екатеринбурге
						</li>
					</ul>

				</li>
				<li>2012 год:ЭкоИнструмент-Алматы
					<ul>

						<li className='ml-6 text-primary_text mb-1'>представительство в Казахстане ЭкоИнструмент-Алматы
						</li>
					</ul>
