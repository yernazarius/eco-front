	...
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<ul className='pl-6 mt-8 list-disc flex flex-col gap-4'>
				...
				<li>2000 год:«Экоинструмент - Алматы»-Волга
					<ul>
						<li className='ml-6 text-primary_text mb-1'>региональный офис «Экоинструмент - Алматы»-Волга в Нижнем Новгороде
						</li>

					</ul>
				</li>
				<li>2001 год:«Экоинструмент - Алматы»-Урал


					<ul>
						<li className='ml-6 text-primary_text mb-1'>региональный офис «Экоинструмент - Алматы»-Урал в Екатеринбурге
						</li>
					</ul>

				</li>
				<li>2012 год:«Экоинструмент - Алматы»-Алматы
					<ul>

						<li className='ml-6 text-primary_text mb-1'>представительство в Казахстане «Экоинструмент - Алматы»-Алматы
						</li>
					</ul>
				...
				<li>2013 год:Официальный представитель ключевых производителей
					<ul>
						...
						<li className='ml-6 text-primary_text mb-1'>вывод ключевых производителей лабораторного оборудования на казахстанский рынок
						</li>
					</ul>
