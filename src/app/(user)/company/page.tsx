...
export default function AboutCompanyPage() {
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p className='mt-6'>Это сказалось на всей последующей деятельности компании: мы всегда были ориентированы на качественные и надежные приборы, показаниям которых можно доверять и при проведении измерений в экстремальных условиях. Именно наша компания вывела на казахстанский рынок такие известные мировые марки, как HANNA Instruments, HACH-Lange, WTW, Eijkelkamp, KERN, Haws, GSSI и другие.</p>
			...
			<p className='mt-6'>
				ТОО «Экоинструмент - Алматы» - поставщик лабораторных, портативных и промышленных приборов контроля качества водных сред в Казахстане и странах СНГ с более чем 30-летним опытом и репутацией ответственного партнера. Пять офисов компании и широкая дилерская сеть делают доступными современные аналитические технологии для лабораторий любого масштаба и в любой точке страны.</p>
			<h3 className='text-center text-3xl font-medium my-12'>ТОО «Экоинструмент - Алматы» - казахстанский производитель готовых тест-кювет для определения ХПК – основного показателя загрязнённости вод.</h3>
			<p className='mt-6'>В сотрудничестве с ведущими проектными и инжиниринговыми компаниями отдел промоборудования ООО &quot;«Экоинструмент - Алматы»&quot; успешно реализует масштабные проекты в области автоматизации экологического контроля, контроля качества питьевой воды и реконструкции очистных сооружений.</p>
