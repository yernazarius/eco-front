...
export default function AboutCompanyPage() {
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p className='mt-6'>
				ООО «Экоинструмент - Алматы» - поставщик лабораторных, портативных и промышленных приборов контроля качества водных сред в Казахстане и странах СНГ с более чем 30-летним опытом и репутацией ответственного партнера. Пять офисов компании и широкая дилерская сеть делают доступными современные аналитические технологии для лабораторий любого масштаба и в любой точке страны.</p>
			<h3 className='text-center text-3xl font-medium my-12'>ООО «Экоинструмент - Алматы» - российский производитель готовых тест-кювет для определения ХПК – основного показателя загрязнённости вод.</h3>
