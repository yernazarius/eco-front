...
export default function AboutCompanyPage() {
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p>ООО «ЭКОИНСТРУМЕНТ» не только является ведущим дистрибьютором аналитического оборудования и оборудования для мониторинга окружающей среды, но также, в рамках своих возможностей, занимается благотворительностью.

			</p>
			<p className='mt-6'>Мы взаимодействуем с несколькими благотворительными фондами, основным направлением деятельности которых является помощь детям. Дети – наше будущее, поэтому ЭКОИНСТРУМЕНТ стремится не только сохранить для них чистую природу и воду, но и помочь им вырасти здоровыми и счастливыми.
