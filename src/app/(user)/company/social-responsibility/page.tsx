...
export default function AboutCompanyPage() {
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p>ТОО «Экоинструмент - Алматы» не только является ведущим дистрибьютором аналитического оборудования и оборудования для мониторинга окружающей среды, но также, в рамках своих возможностей, занимается благотворительностью.
