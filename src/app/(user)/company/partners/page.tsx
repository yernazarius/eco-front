...
export default function HistoryPage() {
	...
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p className='text-primary_text'>ТОО &quot;«Экоинструмент - Алматы»&quot; всегда было ориентировано на качественные и надежные приборы, показаниям которых можно доверять даже при проведении измерений в экстремальных условиях. Именно наша компания вывела на казахстанский рынок такие известные мировые марки, как HANNA Instruments, HACH-Lange, WTW, Eijkelkamp, KERN, Haws, GSSI и другие.
			</p>
