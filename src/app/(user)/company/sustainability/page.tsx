...
export default function AboutCompanyPage() {
	return (
		...
		<div className="md:w-3/4 w-full">
			...
			<p>Друзья. Мы рады представить вам Отчеты об устойчивом развитии Группы компаний Экоинструмент.


			</p>
			<p className='mt-6'>Несмотря на непростые внешние факторы и обстоятельства мы продолжали нашу эффективную работу в соответствии с Целями устойчивого развития ООН, из которых 2 цели имеют непосредственное отношение к деятельности Группы компаний Экоинструмент.
