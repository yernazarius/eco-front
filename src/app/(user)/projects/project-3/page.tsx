	...
	return (
		<div className="md:w-3/4 w-full">
			...
			<div className="text-lg text-justify">
				...
				<p className="mb-4">
					Специалисты Экоинструмен - Алматы оснастили лаборатории завода Каргилл оборудованием, необходимым для всестороннего контроля всех технологических процессов производства, строгого контроля всей производственной цепочки, а также для хранения реагентов и других лабораторных материалов и инструментов.
				</p>
				<p className="mb-4">
