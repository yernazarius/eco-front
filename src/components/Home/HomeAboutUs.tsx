    ...
    return (
        <div className="container mx-auto px-40 mt-12 text-left">
            ...
            <p className="text-lg mb-4">
                &emsp;&emsp;«ЭКОИНСТРУМЕНТ» - поставщик лабораторных, портативных и промышленных приборов контроля качества водных сред в России и странах СНГ с 30 летним опытом и репутацией ответственного партнера. Пять офисов компании и широкая дилерская сеть делают доступными современные аналитические технологии для лабораторий любого масштаба и в любой точке страны.
            </p>
            <p className="text-lg mb-8">
                &emsp;&emsp;«ЭКОИНСТРУМЕНТ» единственный российский производитель готовых тест-наборов для определения ХПК – основного показателя загрязненности вод.
                В сотрудничестве с ведущими проектными и инжиниринговыми компаниями отдел промоборудования ООО &quot;ЭКОИНСТРУМЕНТ&quot; успешно реализует масштабные проекты в области автоматизации экологического контроля, контроля качества питьевой воды и реконструкции очистных сооружений.
            </p>
