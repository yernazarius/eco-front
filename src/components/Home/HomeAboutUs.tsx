    ...
    return (
        <div className="container mx-auto px-40 mt-12 text-left">
            ...
            <p className="text-lg mb-8">
                ...
                В сотрудничестве с ведущими проектными и инжиниринговыми компаниями отдел промоборудования ТОО &quot;«Экоинструмент - Алматы»&quot; успешно реализует масштабные проекты в области автоматизации экологического контроля, контроля качества питьевой воды и реконструкции очистных сооружений.
            </p>
